                        ...
                        <div class="card-body">
                            <div class="row">
                                ...
                                <div class="col">
                                    ...
                                    <p class="text-secondary small text-mute mb-0">Your Appointment was Cancelled</p>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col align-self-center">
                                    ...
                                    <div class="text-dark mb-1 h6 d-block"><img src="doc/d1.jpg" style="height: 50px; width: 50px; border-radius: 50px;">
                                        <a href="doctor.php" class="text-dark mb-1 h6 d-block" style="margin-top: 20px;">Dr.M.P.Agarwal</a><div class="float-right"><img src="img/cancel.jpg" style="height: 80px; width: 80px; border-radius: 50px;"></div>
